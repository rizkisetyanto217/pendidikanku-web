...
export default function TeacherSchedule() {
  ...
  // List ringkas: semua jadwal bulan ini, urut waktu
  ...
  return (
    <div className="w-full p-4 md:p-6 bg-background text-foreground">
      <div className="max-w-screen-xl mx-auto flex flex-col gap-4">
        ...
        {/* Grid: Kalender + Ringkas Aktivitas */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {/* Ringkas Aktivitas (1 kolom di desktop) */}
          <Card>
            <CardHeader className="pb-3 flex-row items-center justify-between">
              <CardTitle className="text-base">Aktivitas Bulan Ini</CardTitle>
              <Button
                size="sm"
                onClick={() =>
                  setEditing({
      ...
      {/* Dialog (desktop=modal; mobile sudah tampil di bawah karena styling default-mu) */}
      {editing && (
        <EditDialog
          value={editing}
