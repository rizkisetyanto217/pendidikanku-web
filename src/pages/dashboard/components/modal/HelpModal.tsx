// src/components/common/UserHelpModal.tsx
...
function Copyable({
  ...
  return (
    ...
    >
      ...
      {children /* opsional, aman kalau tidak diberikan */}
    </Button>
  );
}

export default function UserHelpModal({
  open,
  onOpenChange,
                  ...
                  {contacts.map((c) => (
                    ...
                    >
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* quick copy email/phone jika ada */}
                        {(c.email || c.phone) && (
