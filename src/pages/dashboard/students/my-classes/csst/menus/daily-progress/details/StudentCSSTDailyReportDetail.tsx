// src/pages/sekolahislamku/student/StudentCSSTDailyReportDetail.tsx
...
export default function StudentCSSTDailyReportDetail() {
  ...
  const schedule: ScheduleRow | undefined = useMemo(() => {
    ...
    if (
      ...
      status = undefined; // belum ditandai
    }
    ...
    <div className="w-full mx-auto">
      ...
      <Card className="mt-4">
        ...
        <CardContent className="space-y-4">
          ...
          {/* tombol edit/hapus di student (sementara di-hide, karena biasanya murid tidak boleh edit) */}
          {/* 
