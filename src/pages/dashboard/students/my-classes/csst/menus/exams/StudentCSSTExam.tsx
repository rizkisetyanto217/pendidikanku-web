// src/pages/sekolahislamku/pages/student/StudentCSSTExamList.tsx
...
const StudentCSSTExam: React.FC<StudentClassesExam> = ({ showBack }) => {
  ...
  const examsQ = useQuery<StudentAssessmentListResponse, AxiosError>({
    queryKey: ["student-csst-exams", csstId, pageFromUrl, perPageFromUrl],
    enabled: !!csstId,
    queryFn: async () => {
  ...
  const examsError: string | null = examsQ.isError
    ? extractErrorMessage(examsQ.error)
    : null;
  ...
  const pagination = examsQ.data?.pagination;

  // opsi pertemuan (dari tanggal start ujian)
    ...
    return (
      <div className="p-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold md:text-xl">Ujian</h1>
            <p className="text-xs text-muted-foreground">
              Gagal memuat daftar ujian untuk mata pelajaran ini.
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-4 space-y-2">
            <div className="flex items-start gap-2 text-destructive text-sm">
              ...
              <div>
                ...
                <div className="text-xs break-all">{examsError}</div>
              </div>
            </div>
            <Button
              size="sm"
      ...
      <main className="w-full">
            ...
            {!hasItems && (
              <Card className="border-dashed mt-3">
                <CardContent className="p-6 text-center text-sm text-muted-foreground space-y-2">
                  ...
                  <p>Tidak ada ujian yang cocok dengan filter yang dipilih.</p>
                  <p className="text-xs">
        ...
        >
          <DialogContent className="max-w-lg">
            <DialogHeader>
              <DialogTitle>Pilih bagian ujian</DialogTitle>
              <DialogDescription>
                Ujian ini terdiri dari beberapa bagian. Silakan pilih bagian
...
export default StudentCSSTExam;
