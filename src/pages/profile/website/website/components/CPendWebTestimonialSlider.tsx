...
export default function TestimonialCarousel({
  ...
  React.useEffect(() => {
    ...
    // resume setelah settle (kalau stopOnInteraction true, kita tetap biarkan paused
    // sampai user keluar hover/focus; kalau mau auto-resume, uncomment 3 baris di bawah)
    // api.on("settle", () => {
    //   if (!stopOnInteraction) startTimer();
    // });
